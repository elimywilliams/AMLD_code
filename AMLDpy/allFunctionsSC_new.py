...
#                xCntGoodValues += 1
        ...
        return False
def ProcessRawDataEng( xCar, xDate, xDir, xFilename, bFirst, gZIP, xOut):
    from datetime import datetime
    #import os
    import gzip
    import csv
...
#                xCntGoodValues += 1
        ...
        wind_df['shift_CH4'] = wind_df.CH4.shift(periods = -4)
        ...
        wind_df2.to_csv(fnOut,index=False)
...
def makeGPD(df,lat,lon,cps = 'epsg:4269'):
...
def filterPeak(xCar,xDate,xDir,xFilename, outFolder,whichpass = 0):
    ...
    gdf_buff = gdf_buff.to_crs(epsg=4269)
    ...
    gdfcop = gdfcop.to_crs(epsg=4269).copy()
...
def verPk(totalData):
    ...
    tog_dat = tog_dat.to_crs(epsg = 4269)
